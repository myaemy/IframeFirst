...
public class ActivityUtils {
	 ...
	 * @param data String型数据
	 */
	public static void startActivityForData(Activity activity, Class<?> cls,String data,String title){
		Intent intent = new Intent(activity,cls);
		intent.putExtra("data", data);
	 ...
	 * @param flag int标记
	 */
	public static void startActivityForResultNoData(Activity activity, Class<?> cls,int flag){
		Intent intent = new Intent(activity,cls);
		intent.setFlags(flag);
		activity.startActivityForResult(intent, flag);
	}
